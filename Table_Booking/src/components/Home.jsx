...
function Home() {
    return ( 
        <div className='flex flex-col py-8 md:py-0 md:flex-row bg-gray-200 items-center'>
            <div className='w-full p-10 md:w-1/2 md:px-20'>
                ...
                <div className='flex flex-row items-center space-x-9 mt-10'>
                    <button className='bg-red-600 p-2 px-3 rounded-full text-white'>Book a Table</button>
